...
NOTE: Any edits to the code in this section can me made to Toolkit.Rmd. For subsequent sections, the reference script to edit is indicated.
...
```{r comparability_distribution, child = 'distribution_analysis/examine_var_distributions.Rmd', echo=TRUE}
```
