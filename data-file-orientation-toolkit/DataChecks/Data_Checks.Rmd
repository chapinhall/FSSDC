...
plot1 <-  barplot(100*t(prop.table(as.matrix(summcf_incna[,3:5]),1)),
  ...
  text(0,plot1,sprintf(".%2f",signif(100*t(prop.table(as.matrix(summcf_incna[,3:5]),1))[1,],3)),col="white",cex=.8,pos=4)
  text(100*t(prop.table(as.matrix(summcf_incna[,3:5]),1))[1,],plot1,sprintf(".%2f",signif(100*t(prop.table(as.matrix(summcf_incna[,3:5]),1))[2,],3)),col="white",cex=.8)
