...
Places where we recommend the user consider modifying the code are designated in the report below. We also have set up the R code to read inputs from modifying "setup.yml." Thus, a user can make modifications to this input file for key inputs for the toolkit in place of modifying the R code.  
...
analysis_file$year <- floor(analysis_file[["month"]]/100)

# ADDING NEW VARIABLES TO YAML CODEBOOK
new_classifications <- c("time")
new_types <- c("numeric")
new_names <- c("year")
...
subset_param <- "rptmn>=201101 & rptmn<=201512"
########################################
